  ...
  public List<Event> initialize() throws Exception {
    ...
    try {
      ...
      if (groupingEnabled) {
        ...
        if (getContext() != null) {
          totalResource = getContext().getTotalAvailableResource().getMemorySize();
          taskResource = getContext().getVertexTaskResource().getMemorySize();
          availableSlots = 3;
          LOG.info("XXXX\t" + totalResource + "\t" + taskResource);
        }
